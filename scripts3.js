document.addEventListener('DOMContentLoaded', function() {
    ...
    savePlateBtn.addEventListener('click', function() {
        ...
        savePlateToSessionStorage(plateName);
    ...
    function savePlateToSessionStorage(plateName) {
        let savedPlates = JSON.parse(sessionStorage.getItem('savedBalancedThalis')) || [];
        const currentPlate = JSON.parse(sessionStorage.getItem('currentBalancedThali'));
        ...
        if (currentPlate) {
            ...
            sessionStorage.setItem('savedBalancedThalis', JSON.stringify(savedPlates));
        }
    }

   
    function loadSavedPlates() {
        const savedPlates = JSON.parse(sessionStorage.getItem('savedBalancedThalis')) || [];
            ...
            savedPlates.forEach(plate => {
                ...
                card.innerHTML = `
                    ...
                    <table class="nutritional-info">
                        <tr>
                            <th colspan="2">Nutritional Info:</th>
                        </tr>
                        <tr>
                            <td class="label">Calories:</td>
                            <td class="value">${plate.totals.calories} kcal</td>
                        </tr>
                        <tr>
                            <td class="label">Protein:</td>
                            <td class="value">${plate.totals.protein}g</td>
                        </tr>
                        <tr>
                            <td class="label">Carbs:</td>
                            <td class="value">${plate.totals.carbs}g</td>
                        </tr>
                        <tr>
                            <td class="label">Fat:</td>
                            <td class="value">${plate.totals.fat}g</td>
                        </tr>
                    </table>
